...
export const databaseConfig = {
  ...
  user: process.env.DB_USER || hostingerConfig?.database?.user || 'postgres',
  ...
  url: process.env.DATABASE_URL || hostingerConfig?.database?.url || 'postgresql://postgres:700125733Mm@localhost:5432/u240955251_colliderdb',
